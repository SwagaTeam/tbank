...
{
    public async Task<ICollection<Accounts>> GetByUserIdAsync(Guid userId)
    {
...
{
    public async Task<ICollection<LoyaltyHistory>> GetByAccountIdsAsync(IEnumerable<Guid> accountIds)
    {
        return await DbSet
